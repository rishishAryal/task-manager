<x-layout>
    ...
    <form method="post" action="/register" class="w-full max-w-sm bg-white rounded-lg shadow-md p-6">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            <button type="submit" class="bg-blue-500 text-white rounded-lg px-4 py-2">Register</button>
        </div>
    </form>
    </div>
</x-layout>
